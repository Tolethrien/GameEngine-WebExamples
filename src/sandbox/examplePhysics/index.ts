...
export async function examplePhysicsPreload() {
...
export function examplePhysicsSetup() {
  ...
  DogmaCore.addSystem("PhysKeyInputs");
  DogmaCore.addSystem("indiePhysics");
  DogmaCore.addSystem("PhysAnimator");
  DogmaCore.addSystem("PhysRendering");
}
